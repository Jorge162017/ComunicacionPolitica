...
const products: ProductType[] = [
    {
        id: 1,
        section: "Propuesta",
        link: ['Acerca de', 'Blog', 'Prensa'],
    },
    {
        id: 2,
        section: "Contacto",
        link: ['Ayuda', 'FAQ', 'Afiliate']
    }
]
    ...
    return (
        ...
        <div className="mx-auto max-w-2xl pt-24 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            <div className="my-12 grid grid-cols-1 gap-y-10 sm:grid-cols-6 lg:grid-cols-12">
                ...
                <div className='sm:col-span-6 lg:col-span-5'>
                    <div className="flex flex-shrink-0 items-center border-right">
                        <Image src="/images/Logo/GuateConecta.png" alt="logo" width={100} height={100} />
                        <Link href="/" className='text-2xl font-semibold text-black ml-4'>
                            Guatemala Conecta
                        </Link>
                    </div>
                    <h3 className='text-textbl text-xs font-medium mt-5 mb-4 lg:mb-16'> Apoya a la propuesta</h3>
            ...
            <div className='py-10 md:flex items-center justify-between border-t border-t-bordertop'>
                <h4 className='text-darkgrey text-sm text-center md:text-start font-normal'>@2024 - Guatemala Conecta All Rights Reserved by JorgeLopez.com</h4>

...
const navigation: NavigationItem[] = [
    ...
    { name: 'Objetivos', href: '#about-section', current: false },
    { name: 'Informacion', href: '#cook-section', current: false },
                    ...
                    <div className="relative flex h-12 sm:h-20 items-center">
                        <div className="flex flex-1 items-center sm:justify-between">
                            ...
                            <div className="flex sm:hidden flex-shrink-0 items-center border-right">
                                <Image src="/images/Logo/GuateConecta.png" alt="logo" width={36} height={36} />
                                <Link href="/" className='text-2xl font-semibold text-black ml-4'>
                                    Guatemala Conecta
                                </Link>
                            </div>
                            <div className="hidden sm:flex flex-shrink-0 items-center border-right">
                                <Image src="/images/Logo/GuateConecta.png" alt="logo" width={150} height={150} />
                                <Link href="/" className='text-2xl font-semibold text-black ml-4'>
                                Guatemala Conecta
                                </Link>
                            </div>
                            ...
                            <div className='gap-6 hidden lg:flex'>
                                <div className='flex items-center gap-2'>
                                    ...
                                    <p className='text-lg font-medium'>2410 0000</p>
                                </div>
